  ...
  <div id="app">
    <div id="content">
      <b-navbar
        ...
        type="dark"
      >
        <login class="loginForm loginForm-sm d-lg-none" />
        <b-navbar-toggle
          target="nav-collapse"
          left
        ></b-navbar-toggle>
        ...
        >
          <b-navbar-nav>
            <li>
              ...
              <login class="loginForm loginForm-lg d-none d-lg-inline-block d-xl-inline-block" />
            </li>
          </b-navbar-nav>
        </b-collapse>
      </b-navbar>
      ...
      <p class="sentence">You have a chance to start all again!</p>
      <br>
